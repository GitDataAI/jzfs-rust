...
pub struct HealthConfig {
    ...
    pub cpu: ::prost::alloc::vec::Vec<HealthCpu>,
    #[prost(message, optional, tag = "2")]
    pub memory: ::core::option::Option<HealthMemory>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod health_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::HealthConfig>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/health.Health/Check" => {
                    ...
                    for CheckSvc<T> {
                        type Response = super::HealthConfig;
